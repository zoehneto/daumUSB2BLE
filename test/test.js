...
var port = new com.SerialPort("/dev/ttyUSB0", { baudrate: 9600, parser: com.parsers.byteLength(1) }, false); //if bytelength 1, the received buffer changes accordingly to the send bytes of ergobike
